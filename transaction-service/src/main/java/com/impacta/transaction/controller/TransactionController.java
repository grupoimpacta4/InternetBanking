...
public class TransactionController extends AbstractController {
	...
	public static long returnAccount(String cpf, int type) throws Exception {
		...
		HttpGet httpget = new HttpGet("http://localhost:9011/v1/customers/" + cpf);
		...
		try {
			...
			if (type == 1) {
				...
				String accountNumber = map.getCurrentAccount().getAccountNumber().toString()
						+ map.getCurrentAccount().getCheckDigit();
			...
			if (type == 2) {
				...
				String accountNumber = map.getSavingsAccount().getAccountNumber().toString()
						+ map.getSavingsAccount().getCheckDigit();
				System.out.println(accountNumber);
	...
	public static ResponseDto returnAccountPerUser(String cpf) throws Exception {
		...
		try {
			...
			ObjectMapper mapper = new ObjectMapper();
			ResponseDto response = mapper.readValue(body, ResponseDto.class);
			System.out.println(response.getEmail());
			System.out.println(response.getCurrentAccount().getAccountNumber());
			System.out.println(response.getCurrentAccount().getCheckDigit());
			System.out.println(response.getSavingsAccount().getAccountNumber());
			System.out.println(response.getSavingsAccount().getCheckDigit());
